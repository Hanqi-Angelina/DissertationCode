...
# just start the JVM with try except guards
# try:
#     if not jpype.isJVMStarted():
#         # Get the directory of the current script
#         script_dir = os.path.dirname(os.path.abspath(__file__))
        
#         # Construct the path to the jar file directly
#         tetrad_jar_path = os.path.join(script_dir, 'tetrad-current.jar')
        
#         if not os.path.exists(tetrad_jar_path):
#             print("Error: tetrad-current.jar not found in the same directory as the script.")
#             raise FileNotFoundError("Could not find tetrad-current.jar")
        
#         jpype.startJVM(classpath=[tetrad_jar_path])
#         print("JVM started successfully.")
# except OSError as e:
#     print(f"JVM already started: {e}")
