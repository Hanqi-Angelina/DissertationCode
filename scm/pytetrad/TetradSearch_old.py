...
#         # Construct the path to the jar file in the same directory
#         jar_path = os.path.join(script_dir, "tetrad-current_old.jar")
        
#         # Start the JVM with the memory allocation and the correct classpath
#         jpype.startJVM(jpype.getDefaultJVMPath(), "-Xmx40g", classpath=[jar_path])
#         print("JVM started successfully.")
# except OSError:
#     pass

# import pytetrad.translate as tr
import pytetrad.translate as tr #added tools and get it from the pytetrad package
